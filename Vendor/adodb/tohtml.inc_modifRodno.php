...
GLOBAL $gSQLMaxRows,$gSQLBlockRows,$ADODB_ROUND;
	...
	for ($i=0; $i < $ncols; $i++) {	
		...
		//$hdr .= "<TH class='SubTitulosTables'>$fname</TH>";
	}
    $hdr .=
    '
      <th width="40" class="SubTitulosTables">No</th>
      <th width="80" class="SubTitulosTables">Almacen</th>
      <th width="80" class="SubTitulosTables">C.U.P</th> 
      <th width="80" class="SubTitulosTables">C&oacute;digo</th>  
      <th width="300" class="SubTitulosTables">Descripci&oacute;n</th> 
      <th width="20" class="SubTitulosTables">UM</th> 
      <th width="40" class="SubTitulosTables">Existencia</th>
      <th width="40" class="SubTitulosTables">Precio MN</th> 
      <th width="40" class="SubTitulosTables">Precio MLC</th>
      <th width="40" class="SubTitulosTables">&Uacute;ltimo Movimiento</th>
    ';
	$hdr .= "\n</tr>";
	if ($echo) print $hdr."\n\n";
	else $html = $hdr;
	...
	while (!$rs->EOF) {
		...
		$s .= "<TR onclick='Redireccionar(\"pagina.php\")' valign=top onmouseover='this.className=\"FilaTablaOver\"' onmouseout='this.className=\"FilaTablaOut\"' align='left'>\n";
		...
		for ($i=0; $i < $ncols; $i++) {
			...
			case 'I':
				$s .= "	<TD align=center>".stripslashes((trim($v))) ."&nbsp;</TD>\n";
