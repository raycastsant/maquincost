...
<?php
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $profcorte['Profcorte']['id']), array('class' => 'btn'), __('¿Está seguro que desea eliminar el registro selecionado?', $profcorte['Profcorte']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
