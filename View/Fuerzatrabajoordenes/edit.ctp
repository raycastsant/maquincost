...
<?php echo $this->Form->create('Fuerzatrabajoordene', array('class'=>'form-horizontal')); ?>
	<fieldset>
		<div class="head-form "><h4></a><?php echo __('Editar horas reales trabajadas'); ?></h4></div>
        <br />
	<?php
		...
		echo $this->Form->input('totalhoras', array('div'=>array('class'=>'control-group'), 'class'=>'input', 'label'=>array('class'=>'control-label', 'text'=>'Horas trabajadas&nbsp;')));
