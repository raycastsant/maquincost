...
<?php
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $semiproductoforma['Semiproductoforma']['id']), array('class' => 'btn'), __('¿Está seguro que desea eliminar el registro selecionado?', $semiproductoforma['Semiproductoforma']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
