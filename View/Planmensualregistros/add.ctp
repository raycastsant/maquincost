...
<?php echo $this->Form->create('Planmensualregistro', array('class'=>'form-horizontal')); ?>
	<fieldset>
		<div class="head-form "><h4></a><?php echo __('Insertar registro de plan mensual'); ?></h4></div>
        <br />
	<?php
    ...
    ?>
        <center><table cellpadding="3" cellspacing="1" style="width: 720px;" border="0">
            <tr>
                ...
                <td style="text-align: right; width: 100px;"><?php echo $this->Form->input('numeroorden', array('div'=>array('class'=>'control-group', 'style'=>' padding-top: 10px;'),'class'=>'input', 'value'=>$orden_number, 'name'=>'data[Ordene][numero]', 'label'=>array('class'=>'control-label-3', 'text'=>''))); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align: right;">Tipo de trabajo</td>
                <td style="text-align: right; width: 100px;"><?php echo $this->Form->input('tipotrabajo_id', array('div'=>array('class'=>'control-group', 'style'=>' padding-top: 10px;'),'class'=>'input', 'label'=>array('class'=>'control-label-3', 'text'=>''))); ?></td>
                <td style="text-align: right;">Observaciones</td>
                <td style="text-align: right; width: 100px;"><?php echo $this->Form->input('observaciones', array('div'=>array('class'=>'control-group', 'style'=>' padding-top: 10px;'),'class'=>'input', 'label'=>array('class'=>'control-label-3', 'text'=>''))); ?></td>
            </tr>
        </table></center>
	</fieldset>
