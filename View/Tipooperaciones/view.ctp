<div class="tipooperaciones view">
<h2><?php  echo __('Tipooperacione'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($tipooperacione['Tipooperacione']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($tipooperacione['Tipooperacione']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Tipooperacione'), array('action' => 'edit', $tipooperacione['Tipooperacione']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Tipooperacione'), array('action' => 'delete', $tipooperacione['Tipooperacione']['id']), null, __('Are you sure you want to delete # %s?', $tipooperacione['Tipooperacione']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Tipooperaciones'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Tipooperacione'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($tipooperacione['Ctregistro'])): ?>
	...
	<?php
		$i = 0;
		foreach ($tipooperacione['Ctregistro'] as $ctregistro): ?>
		<tr>
