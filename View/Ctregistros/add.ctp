...
<?php echo $this->Form->create('Ctregistro', array('class'=>'form-horizontal', 'id'=>'CtregistroForm')); ?>
	<fieldset>
		<div class="head-form ">
            <h4><?php echo __('Insertar registro de operación'); ?></h4>
	...
	<?php
		...
		/* echo $this->Form->input('no_orden_operacion', array('div'=>array('class'=>'control-group'),'class'=>'input', 'label'=>array('class'=>'control-label', 'text'=>'no_orden_operacion&nbsp;'))); */
	?>
        <center>
        <table cellspacing="0" cellpadding="0" border="0" style="width: 700px;">
            ...
            <tr>
                <td><?php echo $this->Form->input('diametro_ini', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label-my', 'text'=>'Diámetro inicial (mm)&nbsp;'))); ?></td>
                <td><?php echo $this->Form->input('diametro_fin', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label-my', 'text'=>'Diámetro final (mm)&nbsp;'))); ?></td>
            </tr>
        </table>
        ...
        <table cellspacing="0" cellpadding="0" border="0" style="width: 700px;">
            <tr>
                <td>
                    <div id="ecortantes_loading" style="display: none;"><center><img src="/maquincost/img/loading.gif" alt="Loading..."/></center></div>
        ...
        <table cellspacing="0" cellpadding="0" border="0" style="width: 700px;">
            <tr style="text-align: right;">
                <td><?php echo $this->Form->input('longitud_diametro', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label', 'text'=>'Longitud/Diámetro (mm)&nbsp;'))); ?></td>
                <td><?php echo $this->Form->input('longitud', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label', 'text'=>'Longitud (mm)&nbsp;'))); ?></td>
                <td><?php echo $this->Form->input('cantidad_pasadas', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label', 'text'=>'Cant. de pasadas&nbsp;'))); ?></td>
            </tr>
            <tr style="text-align: right;">
                <td>
                    <div class="control-group">
                        ...
                        <input name="data[Ctregistro][avance]" class="span1" value="0" step="any" type="number" id="CtregistroAvance"/>
                    </div>
                    <?php //echo $this->Form->input('avance', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label', 'text'=>'Avance (mm/rpm)&nbsp;'))); ?></td>
                <td>
                    <div class="control-group">
                        ...
                        <input name="data[Ctregistro][velocidad]" class="span1" value="0" step="any" type="number" id="CtregistroVelocidad"/>
                    </div>
                    <?php //echo $this->Form->input('velocidad', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label', 'text'=>'Vel. de corte(m/min)&nbsp;'))); ?></td>
                <td>
                    <div class="control-group">
                        ...
                        <input name="data[Ctregistro][prof_corte]" class="span1" value="0" step="any" type="number" id="CtregistroProfCorte"/>
                    </div>
                    <?php //echo $this->Form->input('prof_corte', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label', 'text'=>'Profundidad (mm)&nbsp;'))); ?></td>
            </tr>
            <tr style="text-align: right;">
                <td><?php echo $this->Form->input('revoluciones', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label', 'text'=>'Revoluciones (rpm)&nbsp;'))); ?></td>
                <td><?php echo $this->Form->input('tiempo_corte', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label', 'text'=>'T. Corte (min)&nbsp;'))); ?></td>
                <td>
                   <div class="control-group">
                        ...
                        <input name="data[Ctregistro][tiempo_auxiliar]" class="span1" value="0" step="any" type="number" id="CtregistroTiempoAuxiliar"/>
                    </div>
                    <?php //echo $this->Form->input('tiempo_auxiliar', array('div'=>array('class'=>'control-group'),'class'=>'span1', 'value'=>'0', 'label'=>array('class'=>'control-label', 'text'=>'T. Auxiliar (min)&nbsp;'))); ?></td>
            </tr>
        </table>
        </center>
	</fieldset>
...
<script>
    ...
    {        
        $.ajax(
        {
            async:true, beforeSend:function (XMLHttpRequest) {$('#ecortantes_loading').attr('style', ''); $('#ecortantes_input').attr('style', 'display: none');}, 
            data:$("#CtregistroOperacioneId").serialize(), dataType:"html", 
            success:function (data, textStatus) 
            {
                $("#CtregistroElementoscortanteId").html(data);
                $('#ecortantes_loading').attr('style', 'display: none'); 
                $('#ecortantes_input').attr('style', '');
            }, 
