...
<?php echo $this->Form->create('cantidad_surtidos', array('class'=>'form-horizontal', 'url'=>'/reportes/cantidad_surtidos')); ?>
	<fieldset>
		<div class="head-form "><h4></a><?php echo __('Parámetros del reporte Cantidad de surtidos'); ?></h4></div>
        <br />
	<?php
