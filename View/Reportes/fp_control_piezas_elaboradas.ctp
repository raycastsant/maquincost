...
<?php echo $this->Form->create('registro_ordenes', array('class'=>'form-horizontal', 'url'=>'/reportes/control_piezas_elaboradas')); ?>
	<fieldset>
		<div class="head-form "><h4></a><?php echo __('Parámetros del reporte Control de piezas elaboradas'); ?></h4></div>
        <br />
	<?php
