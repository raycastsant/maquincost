...
<?php echo $this->Form->create('registro_ordenes', array('class'=>'form-horizontal', 'url'=>'/reportes/valor_produccion')); ?>
	<fieldset>
		<div class="head-form "><h4></a><?php echo __('Parámetros del reporte Valor de la producción'); ?></h4></div>
        <br />
	<?php
