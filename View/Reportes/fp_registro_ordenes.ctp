...
<?php echo $this->Form->create('registro_ordenes', array('class'=>'form-horizontal', 'url'=>'/reportes/registro_ordenes')); ?>
	<fieldset>
		<div class="head-form "><h4></a><?php echo __('Parámetros del reporte Registro de órdenes'); ?></h4></div>
        <br />
	<?php
