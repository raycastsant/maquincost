<div class="instrumentosauxiliares view">
<h2><?php  echo __('Instrumentosauxiliare'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($instrumentosauxiliare['Instrumentosauxiliare']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($instrumentosauxiliare['Instrumentosauxiliare']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Instrumentosauxiliare'), array('action' => 'edit', $instrumentosauxiliare['Instrumentosauxiliare']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Instrumentosauxiliare'), array('action' => 'delete', $instrumentosauxiliare['Instrumentosauxiliare']['id']), null, __('Are you sure you want to delete # %s?', $instrumentosauxiliare['Instrumentosauxiliare']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Instrumentosauxiliares'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Instrumentosauxiliare'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($instrumentosauxiliare['Ctregistro'])): ?>
	...
	<?php
		$i = 0;
		foreach ($instrumentosauxiliare['Ctregistro'] as $ctregistro): ?>
		<tr>
