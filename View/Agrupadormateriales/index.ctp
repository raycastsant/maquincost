...
<?php
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $agrupadormateriale['Agrupadormateriale']['id']), array('class' => 'btn'), __('¿Está seguro que desea eliminar el registro selecionado?', $agrupadormateriale['Agrupadormateriale']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
