...
<?php
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $operacione['Operacione']['id']), array('class' => 'btn'), __('¿Está seguro que desea eliminar el registro selecionado?', $operacione['Operacione']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
