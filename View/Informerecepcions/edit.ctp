...
<?php echo $this->Form->create('Informerecepcion', array('class'=>'form-horizontal')); ?>
	<fieldset>
		<div class="head-form ">
            <h4></a><?php echo __('Editar informe de recepción'); ?></h4>
    ...
    <div class='form-actions'>
       ...
       <a class='btn' href='/maquincost/informerecepcions/view/<?php echo $ordenreal['Ordenreal']['id']; ?>'><i class='icon-remove-sign'></i>&nbsp;Cancelar</a>
    </div>	
</div>
