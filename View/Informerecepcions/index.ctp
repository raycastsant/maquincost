...
<?php
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $informerecepcion['Informerecepcion']['id']), array('class' => 'btn'), __('¿Está seguro que desea eliminar el registro selecionado?', $informerecepcion['Informerecepcion']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
