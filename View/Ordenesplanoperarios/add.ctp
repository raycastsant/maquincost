...
<?php echo $this->Form->create('Ordenesplanoperario', array('class'=>'form-horizontal')); ?>
	<fieldset>
		<div class="head-form ">
            <h4></a><?php echo __('Insertar registro de operario'); ?></h4>
...
<script>
   ...
   //Actualiza las horas en dependencia de la carta tecnologica
    ...
    $('document').ready(function () 
    {
        ...
        value = $("select#OrdenesplanoperarioCartasordeneId").val();
        $("select#OrdenesplanoperarioCartasordeneId").val(value).change(); 
    });   
</script>