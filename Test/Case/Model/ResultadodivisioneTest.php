...
/**
 * Resultadodivisione Test Case
 *
 */
class ResultadodivisioneTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Resultadodivisione = ClassRegistry::init('Resultadodivisione');
	}
