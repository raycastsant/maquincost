...
/**
 * TipoelementoscortantesController Test Case
 *
 */
class TipoelementoscortantesControllerTest extends ControllerTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Tipoelementoscortantes = new TestTipoelementoscortantesController();
		$this->Tipoelementoscortantes->constructClasses();
	}
 ...
 */
	public function tearDown() {
		unset($this->Tipoelementoscortantes);
