...
/**
 * CalificacionoperariosController Test Case
 *
 */
class CalificacionoperariosControllerTest extends ControllerTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Calificacionoperarios = new TestCalificacionoperariosController();
		$this->Calificacionoperarios->constructClasses();
	}
 ...
 */
	public function tearDown() {
		unset($this->Calificacionoperarios);
